  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Contact — The Boys Farmers Market" },
      {
        ...
        content: "Delray Beach's gourmet farmers market and catering kitchen. Open every day, 8:30am–6:00pm.",
      },
    ],
  }),
        ...
        <section className="overflow-hidden rounded-3xl border border-border/70 bg-card shadow-sm">
          ...
          <div className="space-y-3 p-6">
            ...
            <p className="text-muted-foreground">
              ...
              in-house — bringing the flavors of the market straight to your table.
            </p>
          </div>
        </section>
      </div>
